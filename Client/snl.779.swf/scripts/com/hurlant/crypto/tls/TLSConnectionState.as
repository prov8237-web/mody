package com.hurlant.crypto.tls
{
   ...
   public class TLSConnectionState
   {
      ...
      public function decrypt(param1:uint, param2:uint, param3:ByteArray) : ByteArray
      {
         ...
         {
            (_loc4_ = new ByteArray()).writeBytes(param3,param3.length - this.CIPHER_IV.length,this.CIPHER_IV.length);
            this.cipher.decrypt(param3);
         ...
         if(this.macAlgorithm != MACs.NULL)
         {
            ...
            (_loc8_ = new ByteArray()).writeBytes(param3,_loc6_,this.hmac.getHashSize());
      ...
      public function encrypt(param1:uint, param2:ByteArray) : ByteArray
      {
         ...
         if(this.macAlgorithm != MACs.NULL)
         {
            (_loc4_ = new ByteArray()).writeUnsignedInt(this.seq_hi);
         ...
         {
            this.cipher.encrypt(param2);
            (_loc5_ = new ByteArray()).writeBytes(param2,param2.length - this.CIPHER_IV.length,this.CIPHER_IV.length);
