package com.hurlant.util.der
{
   ...
   public class DER
   {
      ...
      public static function parse(param1:ByteArray, param2:* = null) : IAsn1Type
      {
         ...
         _loc3_ &= 31;
         if((_loc5_ = int(param1.readUnsignedByte())) >= 128)
         {
            _loc7_ = _loc5_ & 127;
            _loc5_ = 0;
            while(_loc7_ > 0)
         ...
         switch(_loc3_)
         {
            ...
            case 16:
               ...
               if((_loc10_ = param2 as Array) != null)
               {
               ...
               while(param1.position < _loc8_ + _loc5_)
               {
                  ...
                  if(_loc15_ != null)
                  {
                     _loc18_ = String(_loc15_.name);
                     _loc19_ = _loc15_.value;
                     if(_loc15_.extract)
                     {
                        _loc21_ = getLengthOfNextElement(param1);
                        (_loc22_ = new ByteArray()).writeBytes(param1,param1.position,_loc21_);
            ...
            case 5:
               return null;
            case 19:
               (_loc13_ = new PrintableString(_loc3_,_loc5_)).setString(param1.readMultiByte(_loc5_,"US-ASCII"));
               return _loc13_;
            case 34:
            case 20:
               (_loc13_ = new PrintableString(_loc3_,_loc5_)).setString(param1.readMultiByte(_loc5_,"latin1"));
               return _loc13_;
            case 23:
               (_loc14_ = new UTCTime(_loc3_,_loc5_)).setUTCTime(param1.readMultiByte(_loc5_,"US-ASCII"));
               return _loc14_;
         }
