   ...
   public class WebSocket extends EventDispatcher
   {
      ...
      private function validateProtocol() : void
      {
         ...
         if(this._protocols)
         {
            ...
            {
               _loc3_ = String(this._protocols[_loc2_]);
               _loc4_ = 0;
      ...
      private function parseUrl() : void
      {
         ...
         var _loc4_:String;
         if((_loc4_ = this._uri.queryRaw).length > 0)
         {
            _loc4_ = "?" + _loc4_;
         }
      ...
      private function fragmentAndSend(param1:WebSocketFrame) : void
      {
         ...
         if(this.config.fragmentOutgoingMessages && param1.binaryPayload && param1.binaryPayload.length > _loc2_)
         {
            ...
            while(_loc5_ <= _loc4_)
            {
               (_loc6_ = new WebSocketFrame()).opcode = _loc5_ === 1 ? param1.opcode : 0;
      ...
      private function processFrame(param1:WebSocketFrame) : void
      {
         ...
         switch(param1.opcode)
         {
            ...
            case WebSocketOpcode.PING:
               ...
               (_loc5_ = new WebSocketEvent(WebSocketEvent.PING,false,true)).frame = param1;
            ...
            case WebSocketOpcode.PONG:
               ...
               (_loc6_ = new WebSocketEvent(WebSocketEvent.PONG)).frame = param1;
      ...
      private function drop(param1:uint = 1002, param2:String = null) : void
      {
         ...
         {
            (_loc4_ = new WebSocketErrorEvent(WebSocketErrorEvent.ABNORMAL_CLOSE)).text = "Close reason: " + param1;
      ...
      {
         var _loc4_:WebSocketFrame;
         (_loc4_ = new WebSocketFrame()).fin = true;
