   ...
   public class RectanglePath2D extends MotionPath
   {
      ...
      override public function update(param1:Event = null) : void
      {
         ...
         while(_loc16_)
         {
            ...
            {
               if((_loc4_ = _loc16_.cachedProgress * (this._rawWidth + this._rawHeight) * 2) > this._rawWidth)
               {
            ...
            else if((_loc4_ = (_loc16_.cachedProgress - 0.5) / 0.5 * (this._rawWidth + this._rawHeight)) <= this._rawWidth)
            {
      ...
      override public function renderObjectAt(param1:Object, param2:Number, param3:Boolean = false, param4:Number = 0) : void
      {
         ...
         if(param2 < 0.5)
         {
            if((_loc7_ = param2 * (this._rawWidth + this._rawHeight) * 2) > this._rawWidth)
            {
               _loc5_ += this._rawWidth;
         ...
         else if((_loc7_ = (param2 - 0.5) / 0.5 * (this._rawWidth + this._rawHeight)) <= this._rawWidth)
         {
