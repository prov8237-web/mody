package com.greensock
{
   ...
   public class TimelineMax extends TimelineLite implements IEventDispatcher
   {
      ...
      public function getActive(param1:Boolean = true, param2:Boolean = true, param3:Boolean = false) : Array
      {
         ...
         var _loc4_:Array = [];
         var _loc5_:Array;
         var _loc8_:int = int((_loc5_ = getChildren(param1,param2,param3)).length);
         var _loc9_:int = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc8_)
         {
            if(!(_loc7_ = _loc5_[_loc6_]).cachedPaused && _loc7_.timeline.cachedTotalTime >= _loc7_.cachedStartTime && _loc7_.timeline.cachedTotalTime < _loc7_.cachedStartTime + _loc7_.cachedTotalDuration / _loc7_.cachedTimeScale && !OverwriteManager.getGlobalPaused(_loc7_.timeline))
            {
               var _loc10_:*;
