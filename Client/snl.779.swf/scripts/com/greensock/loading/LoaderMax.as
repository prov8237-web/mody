package com.greensock.loading
{
   ...
   public class LoaderMax extends LoaderCore
   {
      ...
      public function getChildrenByStatus(param1:int, param2:Boolean = false) : Array
      {
         var _loc3_:Array = [];
         var _loc4_:Array;
         var _loc5_:int = int((_loc4_ = this.getChildren(param2,false)).length);
         var _loc6_:int = 0;
         while(_loc6_ < _loc5_)
         {
      ...
      public function replaceURLText(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         var _loc4_:Array;
         var _loc6_:int = int((_loc4_ = this.getChildren(param3,true)).length);
         while(--_loc6_ > -1)
         {
      ...
      protected function _auditSize(param1:Event = null) : void
      {
         ...
         while(_loc6_ < _loc2_)
         {
            if(!(_loc4_ = this._loaders[_loc6_]).auditedSize && _loc4_.status <= _loc3_)
            {
               if(!_loc5_)
               {
