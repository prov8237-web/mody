package com.junkbyte.console.core
{
   ...
   public class Executer extends EventDispatcher
   {
      ...
      {
         var _loc4_:Executer;
         (_loc4_ = new Executer()).setStored(param3);
      ...
      private function _exec(param1:String) : void
      {
         ...
         while(_loc3_ != null)
         {
            _loc7_ = (_loc6_ = String(_loc3_[0])).charAt(0);
         ...
         for each(_loc5_ in _loc4_)
         {
            if(_loc5_.length)
            {
               if((_loc11_ = this._saved[RETURNED]) && _loc5_ == "/")
               {
                  this._scope = _loc11_;
      ...
      private function execNest(param1:String) : *
      {
         ...
         while(_loc2_ >= 0)
         {
            ...
            if(param1.substring(_loc2_ + 1,_loc3_).search(/\w/) >= 0)
            {
               ...
               _loc7_ = false;
               _loc8_ = _loc2_ - 1;
               while(!(Boolean((_loc9_ = param1.charAt(_loc8_)).match(/[^\s]/)) || _loc8_ <= 0))
               {
                  _loc8_--;
               }
               if(_loc9_.match(/\w/))
         ...
         {
            if((_loc13_ = typeof this._returned) == "object" || _loc13_ == "xml")
            {
      ...
      private function execOperations(param1:String) : ExeValue
      {
         ...
         while(_loc6_ < _loc5_)
         {
            if((_loc7_ = String(_loc4_[_loc6_])).replace(_loc9_,"") != "")
            {
               _loc8_ = this.operate(_loc4_[_loc6_ - 1],_loc7_,_loc4_[_loc6_ + 1]);
               (_loc14_ = ExeValue(_loc4_[_loc6_ - 1])).setValue(_loc8_);
