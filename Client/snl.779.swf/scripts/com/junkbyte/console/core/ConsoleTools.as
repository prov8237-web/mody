   ...
   public class ConsoleTools extends ConsoleCore
   {
      ...
      public function map(param1:DisplayObjectContainer, param2:uint = 0, param3:String = null) : void
      {
         ...
         while(_loc6_ < _loc8_.length)
         {
            ...
            {
               _loc12_ = (_loc11_ = _loc9_ as DisplayObjectContainer).numChildren;
               _loc13_ = 0;
            ...
            if(_loc7_)
            {
               ...
               else
               {
                  while(_loc7_)
                  {
                     if((_loc7_ = _loc7_.parent) is DisplayObjectContainer)
                     {
                        if(_loc4_ > 0)
                        {
                           _loc4_--;
      ...
      public function getStack(param1:int, param2:int) : String
      {
         ...
         var _loc4_:String;
         if(!(_loc4_ = _loc3_.hasOwnProperty("getStackTrace") ? _loc3_.getStackTrace() : null))
         {
            return "";
         }
         var _loc5_:String = "";
         var _loc6_:Array;
         var _loc7_:int = int((_loc6_ = _loc4_.split(/\n\sat\s/)).length);
