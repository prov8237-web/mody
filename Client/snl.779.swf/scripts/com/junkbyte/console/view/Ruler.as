   ...
   public class Ruler extends Sprite
   {
      ...
      private function onMouseClick(param1:MouseEvent) : void
      {
         ...
         else if(this._points.length == 1)
         {
            ...
            (_loc13_ = this.makeTxtField(_loc3_.highColor)).text = this.round(_loc2_.x) + "," + this.round(_loc2_.y);
            _loc13_.x = _loc2_.x;
            _loc13_.y = _loc2_.y - (_loc8_ == _loc2_ ? 14 : 0);
            addChild(_loc13_);
            (_loc13_ = this.makeTxtField(_loc3_.highColor)).text = this.round(_loc4_.x) + "," + this.round(_loc4_.y);
            _loc13_.x = _loc4_.x;
            _loc13_.y = _loc4_.y - (_loc8_ == _loc4_ ? 14 : 0);
            addChild(_loc13_);
            if(_loc10_ > 40 || _loc11_ > 25)
            {
               (_loc13_ = this.makeTxtField(_loc3_.lowColor)).text = this.round(_loc5_.x) + "," + this.round(_loc5_.y);
               _loc13_.x = _loc5_.x;
               _loc13_.y = _loc5_.y;
               addChild(_loc13_);
            }
      ...
      private function makeTxtField(param1:Number, param2:Boolean = true) : TextField
      {
         ...
         (_loc4_ = new TextField()).autoSize = TextFieldAutoSize.RIGHT;
      ...
      private function drawCircleSegment(param1:Graphics, param2:Number, param3:Point, param4:Number = 180, param5:Number = 0) : Point
      {
         ...
         var _loc9_:Point;
         (_loc9_ = this.getPointOnCircle(param2,_loc8_)).offset(param3.x,param3.y);
         param1.moveTo(_loc9_.x,_loc9_.y);
         var _loc10_:Number = 0;
         var _loc11_:int = 1;
         while(_loc11_ <= _loc7_ + 1)
         {
            _loc13_ = (_loc12_ = _loc11_ <= _loc7_ ? _loc11_ : _loc7_) - _loc10_;
            _loc14_ = 1 + 0.12 * _loc13_ * _loc13_;
            (_loc15_ = this.getPointOnCircle(param2 * _loc14_,(_loc12_ - _loc13_ / 2) * (_loc6_ ? -1 : 1) + _loc8_)).offset(param3.x,param3.y);
            (_loc9_ = this.getPointOnCircle(param2,_loc12_ * (_loc6_ ? -1 : 1) + _loc8_)).offset(param3.x,param3.y);
