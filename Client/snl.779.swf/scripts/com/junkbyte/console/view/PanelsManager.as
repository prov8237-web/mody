   ...
   public class PanelsManager
   {
      ...
      public function updateGraphs(param1:Array) : void
      {
         ...
         for each(_loc5_ in param1)
         {
            ...
            {
               _loc7_ = _loc5_.name;
               if(!(_loc8_ = this._graphsMap[_loc7_] as GraphingPanel))
               {
                  if((_loc9_ = _loc5_.rect) == null)
                  {
                  ...
                  if(isNaN(_loc9_.x) || isNaN(_loc9_.y))
                  {
                     ...
                     if((_loc11_ = Math.floor(this._mainPanel.width / _loc10_) - 1) <= 1)
                     {
                        _loc11_ = 2;
                     }
                  ...
                  (_loc8_ = new GraphingPanel(this.console,_loc9_.width,_loc9_.height)).x = _loc9_.x;
                  _loc8_.y = _loc9_.y;
      ...
      public function tooltip(param1:String = null, param2:ConsolePanel = null) : void
      {
         ...
         if(Boolean(param1) && !this.rulerActive)
         {
            ...
            if(param2)
            {
               ...
               if((_loc6_ = _loc4_.bottom - _loc5_.bottom) > 0)
               {
      ...
      private function onPanelStartDragScale(param1:Event) : void
      {
         ...
         if(this.console.config.style.panelSnapping)
         {
            ...
            while(_loc6_ < _loc5_)
            {
               if((Boolean(_loc7_ = this.console.getChildAt(_loc6_) as ConsolePanel)) && _loc7_.visible)
               {
