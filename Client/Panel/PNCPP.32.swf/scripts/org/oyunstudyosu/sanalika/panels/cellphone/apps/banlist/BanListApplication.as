package org.oyunstudyosu.sanalika.panels.cellphone.apps.banlist
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="org.oyunstudyosu.sanalika.panels.cellphone.apps.banlist.BanListApplication")]
   public class BanListApplication extends CellPhoneApplication
   {
       
      
      private var banListView:BanListView;
      ...
      public function BanListApplication()
      {
         super();
      }
      ...
      override public function init() : void
      {
         ...
         this.banListView = new BanListView();
