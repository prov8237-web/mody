package com.oyunstudyosu.utils
{
   ...
   public class STextField extends TextField
   {
      ...
      public function STextField(param1:Boolean = false, param2:Boolean = true)
      {
         ...
         var _loc3_:String = Boolean(Connectr.instance.gameModel) && Connectr.instance.gameModel.language != null ? String(Connectr.instance.gameModel.language) : LocalInstanceConfig.get("LANGUAGE");
         if(_loc3_ == "ar")
         {
