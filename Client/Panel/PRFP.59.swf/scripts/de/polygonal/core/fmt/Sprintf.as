            ...
            if((_loc7_ = param1.charCodeAt(_loc5_++)) == 37)
            {
               ...
               else
               {
                  ...
                  if((_loc13_ & 8192) != 0)
                  {
                     ...
                     if(_loc11_ == 0)
                     {
                        _loc12_ = Std.string(int(_loc14_ + 16384.5) - 16384);
                        if((_loc8_ & 8) != 0)
                        {
                           _loc12_ += ".";
                        }
                     ...
                     else
                     {
                        ...
                        _loc14_ = (_loc16_ = Number(Math.round(_loc14_ / _loc15_))) * _loc15_;
                  ...
                  else if((_loc13_ & 6144) != 0)
                  {
                     ...
                     if((_loc14_ = Number(param2[_loc3_++])) == 0)
                     {
                        _loc18_ = 0;
                        _loc19_ = 0;
                        _loc12_ += "0";
                     ...
                     if(_loc14_ != 0)
                     {
                        _loc12_ += Std.string(_loc14_).substr(0,_loc11_ + 2);
                     }
                     _loc12_ = (_loc12_ += (_loc13_ & 2048) != 0 ? "e" : "E") + (_loc19_ >= 0 ? "+" : "-");
                     if(_loc19_ < 10)
                     {
                        _loc17_ = "0";
                        _loc21_ = 0;
