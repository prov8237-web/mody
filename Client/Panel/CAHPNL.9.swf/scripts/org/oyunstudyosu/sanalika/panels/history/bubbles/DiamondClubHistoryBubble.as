package org.oyunstudyosu.sanalika.panels.history.bubbles
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="org.oyunstudyosu.sanalika.panels.history.bubbles.DiamondClubHistoryBubble")]
   public class DiamondClubHistoryBubble extends BaseHistoryBubble implements IHistorySpeechBubble
   {
      ...
      public function DiamondClubHistoryBubble()
      {
         super();
      }
      ...
      public function speech(param1:String, param2:String, param3:String = "") : void
      {
         ...
         this.sText.htmlText = "<font color=\"#660033\">" + param2 + ": " + "</font>" + "<font color=\"#1B1C26\">" + param3 + "</font>";
         this.sText.height = this.sText.textHeight + 6;
         if(this.sText.numLines == 1)
         {
            this.sText.width = this.sText.textWidth + 6;
         }
         this.bg.width = this.sText.width + this.sText.x * 2;
         this.bg.height = this.sText.height + this.sText.y * 2;
