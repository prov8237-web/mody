package org.oyunstudyosu.sanalika.panels.history.bubbles
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="org.oyunstudyosu.sanalika.panels.history.bubbles.BlackHistoryBubble")]
   public class BlackHistoryBubble extends BaseHistoryBubble implements IHistorySpeechBubble
   {
      ...
      public function BlackHistoryBubble()
      {
         super();
      }
      ...
      public function speech(param1:String, param2:String, param3:String = "") : void
      {
         ...
         this.sText.htmlText = "<font color=\"#EEEEEE\">" + param2 + ": " + "</font>" + "<font color=\"#FFFFFF\">" + param3 + "</font>";
