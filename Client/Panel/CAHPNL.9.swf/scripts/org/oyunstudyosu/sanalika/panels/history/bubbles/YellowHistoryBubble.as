package org.oyunstudyosu.sanalika.panels.history.bubbles
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="org.oyunstudyosu.sanalika.panels.history.bubbles.YellowHistoryBubble")]
   public class YellowHistoryBubble extends BaseHistoryBubble implements IHistorySpeechBubble
   {
      ...
      public function YellowHistoryBubble()
      {
         super();
      }
      ...
      public function speech(param1:String, param2:String, param3:String = "") : void
      {
         ...
         this.sText.htmlText = "<font color=\"#856600\">" + param2 + ": " + "</font>" + "<font color=\"#5E5E5E\">" + param3 + "</font>";
