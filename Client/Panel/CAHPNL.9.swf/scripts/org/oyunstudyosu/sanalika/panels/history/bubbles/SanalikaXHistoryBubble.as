package org.oyunstudyosu.sanalika.panels.history.bubbles
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="org.oyunstudyosu.sanalika.panels.history.bubbles.SanalikaXHistoryBubble")]
   public class SanalikaXHistoryBubble extends BaseHistoryBubble implements IHistorySpeechBubble
   {
      ...
      public function SanalikaXHistoryBubble()
      {
         super();
      }
      ...
      public function speech(param1:String, param2:String, param3:String = "") : void
      {
         ...
         this.sText.htmlText = "<font color=\"#000000\">" + param2 + ": " + "</font>" + "<font color=\"#FFFFFF\">" + param3 + "</font>";
