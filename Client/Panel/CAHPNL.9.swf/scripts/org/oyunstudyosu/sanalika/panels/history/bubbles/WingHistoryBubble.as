package org.oyunstudyosu.sanalika.panels.history.bubbles
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="org.oyunstudyosu.sanalika.panels.history.bubbles.WingHistoryBubble")]
   public class WingHistoryBubble extends BaseHistoryBubble implements IHistorySpeechBubble
   {
      ...
      public function WingHistoryBubble()
      {
         super();
      }
      ...
      public function speech(param1:String, param2:String, param3:String = "") : void
      {
         ...
         this.sText.htmlText = "<font color=\"#1EA4C4\">" + param2 + ": " + "</font>" + "<font color=\"#3760B2\">" + param3 + "</font>";
