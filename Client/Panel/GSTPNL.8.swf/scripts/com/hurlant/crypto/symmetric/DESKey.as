   ...
   public class DESKey implements ISymmetricKey
   {
      ...
      protected function generateWorkingKey(param1:Boolean, param2:ByteArray, param3:uint) : Array
      {
         ...
         while(_loc9_ < 16)
         {
            ...
            while(_loc8_ < 28)
            {
               if((_loc7_ = _loc8_ + totrot[_loc9_]) < 28)
               {
            ...
            while(_loc8_ < 56)
            {
               if((_loc7_ = _loc8_ + totrot[_loc9_]) < 56)
               {
                  _loc6_[_loc8_] = _loc5_[_loc7_];
               }
               else
      ...
      protected function desFunc(param1:Array, param2:ByteArray, param3:uint, param4:ByteArray, param5:uint) : void
      {
         ...
         while(_loc9_ < 8)
         {
            ...
            _loc10_ = uint((_loc10_ = uint((_loc10_ = uint((_loc10_ = uint(SP7[_loc6_ & 63])) | SP5[_loc6_ >>> 8 & 63])) | SP3[_loc6_ >>> 16 & 63])) | SP1[_loc6_ >>> 24 & 63]);
            _loc6_ = uint(_loc7_ ^ param1[_loc9_ * 4 + 1]);
            _loc10_ = uint((_loc10_ = uint((_loc10_ = uint((_loc10_ |= SP8[_loc6_ & 63]) | SP6[_loc6_ >>> 8 & 63])) | SP4[_loc6_ >>> 16 & 63])) | SP2[_loc6_ >>> 24 & 63]);
